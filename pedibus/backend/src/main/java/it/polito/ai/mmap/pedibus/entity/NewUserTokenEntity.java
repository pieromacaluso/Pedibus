...
@Data
@NoArgsConstructor
@Document(collection = "newUserToken")
public class NewUserTokenEntity {
    ...
    // Scadenza dopo 1h
    @Indexed(name = "ttl_index", expireAfterSeconds = 7*24*3600)
    Date creationDate;

    public NewUserTokenEntity(ObjectId userId) {
