...
include::{snippets}/get-notifiche/http-response.adoc[]
...
include::{snippets}/get-notifiche-base/http-response.adoc[]
...
include::{snippets}/get-notifiche-disp/http-response.adoc[]
...
include::{snippets}/delete-notifiche/http-request.adoc[]

==== Example Response

include::{snippets}/delete-notifiche/http-response.adoc[]

==== Example Response body

include::{snippets}/delete-notifiche/response-body.adoc[]

==== CURL request

include::{snippets}/delete-notifiche/curl-request.adoc[]
